...
class CollectionSummaryReportRequest(BaseModel):
    """Request schema for collection summary report"""
    start_date: date = Field(..., description="Start date for the report")
    end_date: date = Field(..., description="End date for the report")


class CollectionSummaryReportResponse(BaseModel):
    """Response schema for collection summary report"""
    start_date: str
    end_date: str
    summary: Dict[str, Any]
