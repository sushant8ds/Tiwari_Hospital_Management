...
async def admit_patient(
    ...
    try:
        ipd_admission = await ipd_crud.admit_patient(
            ...
            attending_doctor_id=ipd.attending_doctor_id,
...
async def discharge_patient(
    ...
    try:
        ipd = await ipd_crud.discharge_patient(
            db=db,
            ipd_id=ipd_id,
            discharge_date=discharge_req.discharge_date,
            diagnosis=discharge_req.diagnosis,
            procedure_performed=discharge_req.procedure_performed,
            operation_date=discharge_req.operation_date,
            discount=discharge_req.discount,
            payment_mode=discharge_req.payment_mode,
