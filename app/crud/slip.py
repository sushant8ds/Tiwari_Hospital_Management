...
class SlipCRUD:
    ...
    async def generate_discharge_slip(
        ...
        net_charges = total_charges - discount
        ...
        slip_content = {
            ...
            "ipd": {
                ...
                "diagnosis": ipd.diagnosis or "N/A",
                "procedure_performed": ipd.procedure_performed or "N/A",
                "operation_date": ipd.operation_date.isoformat() if ipd.operation_date else None,
                "attending_doctor": ipd.attending_doctor.name if ipd.attending_doctor else "N/A",
                "referred_by": ipd.referred_by or "N/A"
            },
